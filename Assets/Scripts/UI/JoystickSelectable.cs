...
public class JoystickSelectable : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (animationOnSelection == ActionOnSelection.ShowHighlight)
        {
            ...
            highlight.color = new Color(highlight.color.r, highlight.color.g, highlight.color.b, 0.3f);
    ...
    {
        if (iData.playerNum == controlledByPlayer && selectionState != SelectionState.SelectedInputLocked)
        {
